...
import Logo from '../../public/images/icon-v2.png';
...
const Footer = () => {
  ...
  return (
    <footer className="footer relative text-[#31c1ff]  border-t-[#d6f7ff] border-t-[1px] text-lg pt-14 pb-2 px-5 md:px-7 mb-2">
      <div className="group">
        <a href="#" onClick={toTop} className=" absolute top-[-28px] left-1/2 w-14 h-14 rounded-full z-10 bg-white group-hover:bg-[#31c1ff] shadow-scrollToTop transform translate-x-[-50%]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="footer-mail md:order-3">
          <a href="mailto:kids@epicat.fun" className="text-base md:text-lg md:before:absolute before:content-[url(../../public/images/email.svg)] before:inline-block before:w-[26px] before:h-[26px] md:before:top-[50%] md:before:transform md:before:translate-y-[-60%]">
